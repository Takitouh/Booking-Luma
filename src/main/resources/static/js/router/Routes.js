...
import {AdminPanelHotelPage} from "../components/admin-panel-hotel/AdminPanelHotelPage.js";
...
import {UserProfilePage} from "../components/user-profile/UserProfilePage.js";
...
export default class Routes {
    ...
    RoutesMap() {
        const routes = {
            ...
            "/my-profile.html": new UserProfilePage(this.appContainer),
            ...
            "/404": new NotFoundPage(this.appContainer)
        }
